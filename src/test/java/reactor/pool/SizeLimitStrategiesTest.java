...
import reactor.pool.SizeLimitStrategies.SizeBasedSizeLimitStrategy;
 ...
 * @author Simon Baslé
 */
class SizeLimitStrategiesTest {

    private static final Logger LOG = Loggers.getLogger(SizeLimitStrategies.class);
    ...
    class AllocatingMaxTest {
        ...
        void negativeMaxGivesOnePermit() {
            SizeLimitStrategy test = new SizeBasedSizeLimitStrategy(-1);
        ...
        void zeroMaxGivesOnePermit() {
            SizeLimitStrategy test = new SizeLimitStrategies.SizeBasedSizeLimitStrategy(0);
        ...
        void onePermitGetDesired() {
            SizeLimitStrategy test = new SizeLimitStrategies.SizeBasedSizeLimitStrategy(1);
        ...
        void returnPermitCanGoOverMax() {
            final SizeLimitStrategy test = new SizeBasedSizeLimitStrategy(1);
        ...
        void returnPermitsCanGoOverMax() {
            final SizeLimitStrategy test = new SizeLimitStrategies.SizeBasedSizeLimitStrategy(1);
        ...
        void raceGetPermit(int workerCount) throws InterruptedException {
            final SizeLimitStrategy test = new SizeLimitStrategies.SizeBasedSizeLimitStrategy(10);
        ...
        void racePermitsRandom(int workerCount, TestInfo testInfo) throws InterruptedException {
            final SizeLimitStrategy test = new SizeBasedSizeLimitStrategy(10);
    ...
    class UnboundedTest {
        ...
        void permitCountIsMaxValue() {
            SizeLimitStrategy test = SizeLimitStrategies.UNBOUNDED;
        ...
        void returnPermitsDoesntChangeMax() {
            final SizeLimitStrategy test = SizeLimitStrategies.UNBOUNDED;
